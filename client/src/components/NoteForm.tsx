...
const NoteForm: React.FC<NoteFormProps> = ({ onInputChange }) => {
  ...
  placeholder="Content"
  className="w-full text-left md:h-[200px] px-3 py-2 mb-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500 dark:bg-gray-700 dark:text-white"
  rows={5}
/>
